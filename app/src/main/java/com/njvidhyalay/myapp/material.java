...
public class material extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(indexref.equals("B.A.")){
            myRef = database.getReference().child(linkref).child("materiallink").child("BA");
        }
        else if(indexref.equals("S.P.C.C.")){
            myRef = database.getReference().child(linkref).child("materiallink").child("SPCC");
        }else{
            myRef = database.getReference().child(linkref).child("materiallink").child(indexref);
        }
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    relativelayout = findViewById(R.id.materialinsidelayout);
                    ...
                    dumbview.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            editor.apply();
                            editor.commit();
                            Toast.makeText(material.this, "Downloading...", Toast.LENGTH_LONG).show();
                    ...
                    my_button[Index] = new Button(material.this);
