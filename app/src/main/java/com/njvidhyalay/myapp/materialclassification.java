...
public class materialclassification extends AppCompatActivity {
...
//                    }
                ...
                int j;
                for (j = 0; j < 11; j++) {
                    textview = new TextView(materialclassification.this);
                    ...
                    textview.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            SharedPreferences settings = getSharedPreferences("materialindex", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editor = settings.edit();
                            editor.putString("index", subjectlist11and12.get(finalJ));
                            editor.apply();
                            editor.commit();

                            Intent intent = new Intent(materialclassification.this, material.class);
            ...
            for (j = 0; j <8; j++) {
                ...
                textview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        SharedPreferences settings = getSharedPreferences("materialindex", Context.MODE_PRIVATE);
                        SharedPreferences.Editor editor = settings.edit();
                        editor.putString("index", subjectlist1to5.get(finalJ));
                        editor.apply();
                        editor.commit();
                ...
                for (j = 0; j < 7; j++) {
                    ...
                    textview.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            SharedPreferences settings = getSharedPreferences("materialindex", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editor = settings.edit();
                            editor.putString("index", subjectlist6to10.get(finalJ));
                            editor.apply();
                            editor.commit();
            ...
            findViewById(R.id.loadingpanelmaterialclassification).setVisibility(View.GONE);
        }
    }
